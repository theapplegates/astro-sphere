const id = "05-astro-sphere-writing-mdx/index.mdx";
						...
						const data = {title:"Astro Sphere: Writing MDX",summary:"Lorem ipsum dolor sit amet",date:new Date(1710216000000),tags:["Tutorial","Astro","Astro Sphere","Markdown","MDX"],draft:false};
						const _internal = {
							type: 'content',
							filePath: "/Users/thor3/Movies/test22/astro-sphere/src/content/blog/05-astro-sphere-writing-mdx/index.mdx",
							rawData: undefined,
						};
